...
/**
 * 建立部门、员工、角色、菜单、权限、会话和操作日志等系统基础表。
 */
module.exports = {
  async up(queryInterface, Sequelize) {
    // 业务基础表共用创建时间和自动更新时间字段。
    const common = {
      created_at: {
        type: Sequelize.DATE,
        allowNull: false,
    ...
    await queryInterface.createTable(
      'sys_employees',
      {
        ...
        department_id: {
          type: Sequelize.BIGINT.UNSIGNED,
          allowNull: false,
          references: { model: 'sys_departments', key: 'id' },
          onUpdate: 'CASCADE',
          onDelete: 'RESTRICT',
        },
        name: { type: Sequelize.STRING(50), allowNull: false },
        phone: { type: Sequelize.STRING(20), allowNull: false, unique: true },
        account: { type: Sequelize.STRING(50), allowNull: false, unique: true },
    ...
    await queryInterface.createTable(
      'sys_employee_roles',
      {
        ...
        role_id: {
          type: Sequelize.BIGINT.UNSIGNED,
          primaryKey: true,
          references: { model: 'sys_roles', key: 'id' },
          onDelete: 'RESTRICT',
        },
    ...
    await queryInterface.createTable(
      'sys_menus',
      {
        ...
        name: { type: Sequelize.STRING(80), allowNull: false },
        code: { type: Sequelize.STRING(50), allowNull: false, unique: true },
        path: { type: Sequelize.STRING(160), allowNull: true },
        parent_id: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
        sort: {
    ...
    await queryInterface.createTable(
      'sys_role_menus',
      {
        ...
        menu_id: {
          type: Sequelize.BIGINT.UNSIGNED,
          primaryKey: true,
          references: { model: 'sys_menus', key: 'id' },
          onDelete: 'CASCADE',
        },
        created_at: common.created_at,
      },
    ...
    await queryInterface.createTable(
      'sys_role_permissions',
      {
        ...
        permission_id: {
          type: Sequelize.BIGINT.UNSIGNED,
          primaryKey: true,
          references: { model: 'sys_permissions', key: 'id' },
          onDelete: 'CASCADE',
        },
        created_at: common.created_at,
      },
    ...
    await queryInterface.addIndex('sys_sessions', ['expires_at'])
    await queryInterface.createTable(
      'sys_operation_logs',
      {
        id: {
        ...
        target_id: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
    ...
    await queryInterface.addIndex('sys_operation_logs', [
      'employee_id',
      'created_at',
    ])
  },
