...
module.exports = (app) => {
  ...
  const requestLogger = app.middleware.requestLogger()
  ...
  const dashboardMenu = app.middleware.menuPermission({
    code: 'shortcut_dashboard',
  })
  ...
  const productionPermission = (code) =>
    app.middleware.operationPermission({ code })
  const qualityMenu = app.middleware.menuPermission({
    code: 'shortcut_products',
  })
  ...
  // 公开基础接口。
  router.get('/api/v1/health', requestLogger, controller.health.index)
  router.get('/api/v1/auth/captcha', requestLogger, controller.auth.captcha)
  ...
  router.get(
    ...
    auth,
    productMenu,
    productPermission('product.edit'),
  ...
  router.post(
    ...
    auth,
    productMenu,
    productPermission('product.create'),
  ...
  router.patch(
    ...
    auth,
    productMenu,
    productPermission('product.status'),
    controller.products.updateStatus,
  )
  router.delete(
    '/api/v1/products/:id',
    auth,
    productMenu,
    productPermission('product.delete'),
    controller.products.destroy,
  )
  router.post(
  ...
  router.get(
    ...
    auth,
    qrcodeMenu,
    controller.qrcodes.products,
  )
  router.get(
    '/api/v1/qrcodes/batches',
    auth,
    qrcodeMenu,
    qrcodePermission('qrcode.bind'),
    controller.qrcodes.batches,
  )
  router.get(
    '/api/v1/qrcodes/label-print/batches',
    auth,
    qrcodeMenu,
    qrcodePermission('qrcode.view'),
    controller.qrcodes.labelPrintBatches,
  )
  router.get(
    '/api/v1/qrcodes/label-print/batches/:batchNo',
    auth,
    qrcodeMenu,
    qrcodePermission('qrcode.view'),
    controller.qrcodes.labelPrintBatch,
  )
  router.post(
  ...
  router.post(
    ...
    qrcodeMenu,
    qrcodePermission('qrcode.bind'),
    controller.qrcodes.bind,
  )

  // 生产中心的多类资源复用同一组控制器方法，由 URL 解析具体资源类型。
  router.get(
    '/api/v1/production/options',
    auth,
    productionMenu,
    productionPermission('production.view'),
    controller.production.options,
  )
  router.get(
  ...
  router.get(
    ...
    productionMenu,
    productionPermission('production.view'),
    controller.production.show,
  )
  router.post(
    '/api/v1/production/orders',
    auth,
    productionMenu,
    productionPermission('production.order.create'),
  ...
  router.put(
    ...
    auth,
    productionMenu,
    productionPermission('production.order.edit'),
  ...
  router.patch(
    '/api/v1/production/batches/:id/status',
    auth,
    productionMenu,
    productionPermission('production.batch.manage'),
    controller.production.updateStatus,
  ...
  router.post(
    ...
    auth,
    productionMenu,
    productionPermission('production.record.manage'),
    controller.production.createBatchStep,
  )
  router.delete(
    '/api/v1/production/batches/:id/steps/:stepId',
    auth,
    productionMenu,
    productionPermission('production.record.manage'),
    controller.production.deleteBatchStep,
  )
  router.get(
    '/api/v1/production/processes',
    auth,
    productionMenu,
    productionPermission('production.view'),
    controller.production.index,
  ...
  router.post(
    ...
    auth,
    productionMenu,
    productionPermission('production.process.manage'),
    controller.production.create,
  )
  router.put(
    '/api/v1/production/processes/:id',
    auth,
    productionMenu,
    productionPermission('production.process.manage'),
    controller.production.update,
  ...
  router.patch(
    '/api/v1/production/processes/:id/status',
    auth,
    productionMenu,
    productionPermission('production.process.manage'),
    controller.production.updateStatus,
  ...
  router.post(
    ...
    auth,
    productionMenu,
    productionPermission('production.outbound.manage'),
    controller.production.create,
  )
  router.put(
    '/api/v1/production/outbounds/:id',
    auth,
    productionMenu,
    productionPermission('production.outbound.manage'),
    controller.production.update,
  ...
  // 质量中心。
  router.get(
    '/api/v1/quality/options',
    auth,
    qualityMenu,
    qualityPermission('quality.view'),
    controller.quality.options,
  )
  router.get(
  ...
  router.post(
    ...
    auth,
    qualityMenu,
    qualityPermission('quality.report.create'),
    controller.quality.createReport,
  )
  router.post(
    '/api/v1/quality/reports/quick',
    auth,
    qualityMenu,
    qualityPermission('quality.report.create'),
    controller.quality.quickCreateReport,
  )
  router.get(
    '/api/v1/quality/reports/:id',
    auth,
    qualityMenu,
    qualityPermission('quality.view'),
  ...
  router.patch(
    '/api/v1/quality/reports/:id/status',
    auth,
    qualityMenu,
    qualityPermission('quality.report.review'),
    controller.quality.reviewReport,
  )
  router.delete(
    '/api/v1/quality/reports/:id',
    auth,
    qualityMenu,
    qualityPermission('quality.report.create'),
    controller.quality.deleteReport,
  )
  router.get(
    '/api/v1/quality/reports/:id/file',
    auth,
    qualityMenu,
    qualityPermission('quality.report.download'),
    controller.quality.reportFile,
  )
  router.get(
  ...
  router.post(
    ...
    auth,
    systemMenu,
    controller.system.createEmployee,
  )
  router.put(
    '/api/v1/system/employees/:id',
    auth,
    systemMenu,
    controller.system.updateEmployee,
  )
  router.patch(
    '/api/v1/system/employees/:id/status',
    auth,
    systemMenu,
    controller.system.updateEmployeeStatus,
  )
  router.post(
    '/api/v1/system/employees/:id/reset-password',
    auth,
    systemMenu,
    controller.system.resetEmployeePassword,
  )
  router.delete(
    '/api/v1/system/employees/:id',
    auth,
    systemMenu,
    superAdmin,
    controller.system.deleteEmployee,
  )
  ...
  router.post(
    ...
    auth,
    systemMenu,
    controller.system.createRole,
  )
  router.put(
    '/api/v1/system/roles/:id',
    auth,
    systemMenu,
    controller.system.updateRole,
  )
  router.patch(
    '/api/v1/system/roles/:id/status',
    auth,
    systemMenu,
    controller.system.updateRoleStatus,
  )
  router.delete(
    '/api/v1/system/roles/:id',
    auth,
    systemMenu,
    superAdmin,
    controller.system.deleteRole,
  )
  router.get(
    '/api/v1/system/operation-logs',
    auth,
    systemMenu,
    controller.system.operationLogs,
  )
}
