...
<template>
  <main class="relative min-h-screen overflow-hidden bg-[#eef4ff] px-4 py-4 sm:px-6 sm:py-6 lg:px-8 lg:py-8">
    ...
    <div class="relative mx-auto grid min-h-[calc(100vh-5rem)] max-w-7xl grid-cols-1 overflow-hidden rounded-4 bg-white shadow-[0_30px_80px_rgba(29,78,216,0.14)] sm:rounded-6 lg:min-h-[calc(100vh-6rem)] lg:grid-cols-[1.15fr_0.85fr]">
